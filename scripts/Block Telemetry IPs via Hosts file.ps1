...
Remove-NetFirewallRule -DisplayName "PowerSOptimize Block Telemetry IPs" -ErrorAction SilentlyContinue
New-NetFirewallRule -DisplayName "PowerSOptimize Block Telemetry IPs" -Direction Outbound `
