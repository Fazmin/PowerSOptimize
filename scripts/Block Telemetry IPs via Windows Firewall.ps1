...
Remove-NetFirewallRule -DisplayName "PowerSOptimize Microsoft Telemetry Block" -ErrorAction SilentlyContinue
New-NetFirewallRule -DisplayName "PowerSOptimize Microsoft Telemetry Block" -Direction Outbound `
